...
import { Truck, Mail, Lock, Eye, EyeOff, AlertTriangle, Shield, ArrowLeft } from 'lucide-react';
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-gray-900">
                Driver {isLogin ? 'Sign In' : 'Sign Up'}
              </h1>
              <p className="mt-2 text-sm text-gray-600">
                {isLogin 
                  ? 'Welcome back! Please sign in to your driver account.'
                  : 'Join Safe Ride as a driver and start earning today.'
                }
              </p>
            </div>
            ...
            {!isLogin && (
              <Alert className="border-green-200 bg-green-50">
                ...
                <AlertDescription className="text-green-800">
                  Your driver account will require verification and document upload 
